# White Album Restoration Patch 0.2 (August 5, 2023)
...
4) Download the [xdelta file](wa_honorifics-v0.2.xdelta) and apply to your **Data/Game/ENG/Script.sdat** file using Delta Patcher.
